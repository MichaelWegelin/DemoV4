sap.ui.define([
	...
	"sap/ui/Device",
	"de/wegelin/model/models",
	"de/wegelin/controller/ListSelector",
	"de/wegelin/controller/ErrorHandler",
	"de/wegelin/model/formatter"
], function(UIComponent, Device, models, ListSelector, ErrorHandler) {
	"use strict";

	return UIComponent.extend("de.wegelin.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "de.wegelin.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "de.wegelin.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/sap/Z00_FIORI_GW_SERVICE_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				...
				"routes": [{
					...
					"pattern": "BusinessPartnerSet/Create",
					"name": "create",
					"target": ["master", "create"]
				}, {
					"pattern": "BusinessPartnerSet/Edit/{objectId}",
					"name": "edit",
					"target": ["master", "edit"]
				}, {
